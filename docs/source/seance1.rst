...
.. note::
   ...
   Libre à vous bien sûr de mettre votre éditeur dans la langue de votre choix, mais il se peut que certains boutons n'aient pas les mêmes libellés.
   Vous pouvez changer la langue de l'éditeur dans les `paramètres` en haut à droite du `Project Manager`.
